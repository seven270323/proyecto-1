address suiz3 { // Ahora usamos una nueva sintaxis, ya que vamos a tener distintos modulos dentro la misma address.
    module funciones1 {
        ...
        fun prueba() {
            retorno();
            let a = retorno_condicional(0); // Es importante notar que si vamos a regresar algo necesita ser consumido. A menos que tenga la habilidad drop
    ...
    module funciones4 {
        ...
        #[ext(view)] // Por ultimo, podemos tener funciones de lectura, se asignan con #[ext(view)].
